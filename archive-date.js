...
function resetArchiveNoteEditor(){archiveEditingNote=null;window.noteEditorImages=[];let existing=$('#existingNoteImages');if(existing)existing.innerHTML='';$('.note-editor h2').textContent='随手记';$('.note-editor p').textContent='会自动记录当前日期与时间，并在 Excel 中按天汇总。';$('#saveNote').textContent='保存随手记'}
